	...
	return(
		<List fontSize={'0.75em'} spacing={2}>
			<ListItem
				...
				<ListIcon as={CheckIcon} color={hasNumber ? iconStates.valid : iconStates.invalid}/>
				Contiene un número
			</ListItem>
			<ListItem
				color={hasUpperCase ? textStates.valid : textStates.invalid}
				display="flex" alignItems="center">
				<ListIcon as={CheckIcon} color={hasUpperCase ? iconStates.valid : iconStates.invalid}/>
				Contiene una mayúscula
			</ListItem>
			<ListItem
				color={hasLowerCase ? textStates.valid : textStates.invalid}
				display="flex" alignItems="center">
				<ListIcon as={CheckIcon} color={hasLowerCase ? iconStates.valid : iconStates.invalid}/>
				Contiene una minúscula
			</ListItem>
			<ListItem
				color={hasSpecialChar ? textStates.valid : textStates.invalid}
				display="flex" alignItems="center">
				<ListIcon as={CheckIcon} color={hasSpecialChar ? iconStates.valid : iconStates.invalid}/>
				Contiene un caracter especial
			</ListItem>
			<ListItem
				color={hasValidLength ? textStates.valid : textStates.invalid}
				display="flex" alignItems="center">
				<ListIcon as={CheckIcon} color={hasValidLength ? iconStates.valid : iconStates.invalid}/>
